...
export class CancelSAuthComponent extends CancelCommonAuthComponent implements OnInit {
  
  constructor(public translateService: TranslateService,
              public router: Router,
              public tymxRouterService: TymxRouterService) {
    super(translateService, router, tymxRouterService);
    this.viewModel.cancelType = 1;
    this.viewModel.isGoogleAuth = false;
  }
